...
\begin{algorithmic}[1]
\REQUIRE Current pose $T_{si}$, desired pose $T_{si}^d$, desired twist ${}^i V_i^d$, desired acceleration ${}^i \dot{V}_i^d$, current twist ${}^i V_i$, measured wrench ${}^i F_{\text{ext}}$, impedance gains $(D_d, K_d)$
\ENSURE Wrench command ${}^i F_i^{\text{cmd}}$
...
\begin{algorithmic}[1]
\REQUIRE Current pose $T_{si}$, desired pose $T_{si}^d$, desired twist ${}^i V_i^d$, current twist ${}^i V_i$, measured wrench ${}^i F_{\text{ext}}$, screw axis $B_i$, impedance params $(D_\parallel, K_\parallel, D_\perp, K_\perp)$
\ENSURE Wrench command ${}^i F_i^{\text{cmd}}$
...
\ENSURE Screw axes $\{B_L, B_R\}$ in body frames
