...
We validate SWIVL on SE(2) benchamarks with articulated objects spanning three joint types: fixed, revolute, and prismatic. Our results demonstrate that SWIVL achieves higher success rates and lower internal forces compared to imitation learning baselines, highlighting the importance of explicit physical modeling for bimanual manipulation of articulated objects.