...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.85\linewidth]{figures/bimanipulation_example_image.jpg}
    \caption{\textbf{Bimanual manipulation of an articulated object.} Two robot arms cooperatively manipulate a shared object with internal degrees of freedom. This task requires simultaneous satisfaction of kinematic constraints imposed by the object's joints and regulation of inter-arm contact forces---capabilities that current imitation-based approaches lack.}
    \label{fig:teaser}
\end{figure}
